...
class _MyAppState extends State<MyApp> {
  final List<Person> _people = [
    Person('Danica Garcia', 'Basista Pangasinan', 'September 2, 2001',
        'https://www.facebook.com/profile.php?id=100041864473256'),
    Person('Sandara Teng', 'Soul, Korea', 'June 24, 1996',
